...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_NEWS),
          REQUEST(ACTION_TYPES.UPDATE_NEWS),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_NEWS),
          REQUEST(ACTION_TYPES.DELETE_NEWS),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_NEWS),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_NEWS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_NEWS),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_NEWS),
          payload: resolvedObject,
        },
      ];
